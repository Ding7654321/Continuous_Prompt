...
def main():
    ...
    parser.add_argument("--gen_dir", type=str, default="e2e_results")
    ...
    if args.task_mode == 'data2text':
        ...
        if QUICK_CHECK:
            ...
            if ('lowdata' in args.model_name_or_path) or (args.prefixModel_name_or_path is not None and 'lowdata' in args.prefixModel_name_or_path):
                test_path = '/home/CE/xueting/PrefixTuning-Fix/data/drone_data/valid_edit.csv'
            else:

                if args.eval_dataset == 'valid':
                    test_path = '/home/CE/xueting/PrefixTuning-Fix/data/drone_data/valid_edit.csv'
                elif args.eval_dataset == 'test':
                    test_path = '/home/CE/xueting/PrefixTuning-Fix/data/drone_data/test_edit.csv'
            ...
            decode_mode = 'beam'
            #dingedit
            curr_dir = os.path.join('/home/CE/xueting/PrefixTuning-Fix/gpt2/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file, decode_mode))
            print("curr_dir")
            print(curr_dir)
            gold_dir = os.path.join('/home/CE/xueting/PrefixTuning-Fix/gpt2/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file,'gold'))
            print("gold_dir")
            print(gold_dir)
            write_e2e_corr(prompt_text_lst, prompt_text_dict, gold_dir)
            src_dir = os.path.join('/home/CE/xueting/PrefixTuning-Fix/gpt2/',
                                   args.gen_dir,
        ...
        if args.task_mode == 'webnlg':
            if args.eval_dataset == 'valid':
                #dingedit
                test_path = "/home/CE/xueting/PrefixTuning-Fix/data/webnlg_challenge_2017/dev.json"
            elif args.eval_dataset == 'test':
                test_path = "/home/CE/xueting/PrefixTuning-Fix/data/webnlg_challenge_2017/test.json"
            else:
    ...
    if args.task_mode == 'data2text':
        ...
        print(out_file_eval, '\n', gold_dir, '\n', curr_dir)
        os.system("python /home/CE/xueting/PrefixTuning-Fix/data/Evaluation/e2e-metrics/measure_scores.py "
        ...
        #dingedit
        os.system("bash /home/CE/xueting/PrefixTuning-Fix/data/Evaluation/dart/evaluation/run_eval_on_webnlg.sh "
