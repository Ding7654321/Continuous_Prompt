...
if __name__ == '__main__':
    ...
    # Added by MX
    #dingedict
    parser.add_argument('--cache_dir', type=str, default='/home/CE/xueting/PrefixTuning-Fix/gpt2',
                        help='cache dir')
    ...
    if args.mode == 'data2text':
        ...
        TRAIN_FILE = "/home/CE/xueting/PrefixTuning-Fix/data/drone_data/train_edit.csv"
        TEST_FILE = "/home/CE/xueting/PrefixTuning-Fix/data/drone_data/test_edit.csv"
        folder_name = 'save_e2e_models_/'
        ...
        #dingedit
        TRAIN_FILE = "/home/CE/xueting/PrefixTuning-Fix/data/webnlg_challenge_2017/train.json"
        TEST_FILE = "/home/CE/xueting/PrefixTuning-Fix/data/webnlg_challenge_2017/dev.json"
    ...
    if OLD_MODEL == 'gpt2-large':
        ...
        # dingedit
        app += f' --cache_dir "/home/CE/xueting/PrefixTuning-Fix/gpt2-medium" '
